...
local programListUrl = "https://raw.githubusercontent.com/Coopper228/GTNH-OC-Installer/main/programs.lua"
...
local function main()
  ...
  term.clear()
  term.write("Welcome to Coopper228's programs installer\n\n")
